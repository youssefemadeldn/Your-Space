...
/// Local mirror of the synced [SubGroup] entity (`lib/core/entities/subgroup.dart`).
///
/// `groupId` is a plain FK column — no drift-level foreign-key constraint
/// (matches `PersonsTable`'s denormalized parent-id columns); `watchSubGroups`
...
class SubGroupsTable extends Table {
  ...
  // (design doc §6/§11 row 8.17); Tier 1 upserts have no value to put here yet.
