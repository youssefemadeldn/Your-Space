...
abstract class GovernorateRepository {
  ...
  /// Tier 3 real delta pull (design doc §6, row 8.6): cursor-based, against
  /// `GET /governorates/changes`, mirrors `GroupRepository.refreshGroups()`
  /// exactly. The result only signals whether the fetch itself succeeded —
  /// on failure the UI keeps showing cached data (design doc §3).
