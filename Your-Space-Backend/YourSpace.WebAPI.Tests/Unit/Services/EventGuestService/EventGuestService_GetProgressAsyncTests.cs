...
public class EventGuestService_GetProgressAsyncTests
{
    ...
    public async Task Includes_every_group_even_ones_with_zero_guests_added_to_this_event_yet()
    {
        ...
        var personInRelatives = new Person { Id = 10, OwnerUserId = "owner-1", Name = "Ahmed", GroupId = 1 };
        var personInVillageFriends = new Person { Id = 11, OwnerUserId = "owner-1", Name = "Sara", GroupId = 2 };
