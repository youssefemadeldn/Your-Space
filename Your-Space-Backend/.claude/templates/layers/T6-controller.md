---
name: T6-controller
governed-by: CLAUDE.md "Response envelope" · CLAUDE.md Architecture rule 8 ("Localization") · CLAUDE.md Architecture rule 10 ("ErrorCode") · dotnet_feature_prompt.md Rule 6, Rule 8, Rule 10 & §6 (API layer checklist)
---
...
if (string.IsNullOrWhiteSpace(userIdClaim) || !int.TryParse(userIdClaim, out var userId))
    return new ResultActionResult<SomeDto>(ServiceResult<SomeDto>.Unauthorized(_localizer["Auth.InvalidUserId"], "Auth.InvalidUserId"));
```
