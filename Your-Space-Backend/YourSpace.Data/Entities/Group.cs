...
public class Group
{
    ...
    // Assigned from the "Groups_SyncVersion_seq" Postgres sequence via ISyncVersionProvider on
    // every create/update/soft-delete (GroupService), never left to its column default after
